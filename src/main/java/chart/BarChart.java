...
public static class BarChartBuilder {
    ...
    public BarChartBuilder(String title, String fontName) {
        this.title = title;
        ...
        public BarChartBuilder getHeight() {
            return height;
        }

        public BarChartBuilder setHeight(int height) {
            this.height = height;
        }

        public BarChartBuilder getBackgroundColor() {
            return backgroundColor;
        }

        public BarChartBuilder setBackgroundColor(String backgroundColor) {
